...
Le but de ce projet est de concevoir et de développer un site Web utilisant la plateforme WordPress, destiné à présenter les informations relatives à la formation(KALANSO). Le site permettra aux visiteurs de consulter les détails sur la formation, de parcourir les profils des apprenants, ainsi que de visualiser leurs CV.

## 1.1 logo

- Texte: Kalanso Academy
- image:

## 1.2 Charte Graphique

La charte represente les couleur d'Orange

- Couleur 1: Orange
- Couleur 2 : Noir
- Couleur par defaut: Branche
...
- **CMS** : WordPress
- **Thème Utilisé** : Astra(thème responsive)
...
- Pages Principales :
  ...
  - Page d'accueil
    ( introduction du centre orange avec les activités récentes)
  - Formation
    (Introduction de ODK, objectif, etc...)
  - Apprenants
    (Page contenant les images des apprenants à ODK)
  - Detail profil(non visible)
    ( page contenant les details de chaque apprenant, leur contact, email...)
  - Contact
    (Page de formulaire pour mettre de soumettre des suggestion)
